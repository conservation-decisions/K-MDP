...
%K = [round(NS), round(NS/1.25), round(NS/1.5), round(NS/2), round(NS/3), round(NS/4), round(NS/6), round(NS/8), round(NS/10), round(10), round(5)];
...
%fprintf('KMEANS\n');
%[PK_kmeans, RK_Kmeans, S2K_kmeans, K2S_kmeans, PolicyK_kmeans, PolKs_kmeans, err_kmeans, t_kmeans, t_KMDP_kmeans] = kmeansKMDP(200, P, R, discount, Q, V);
